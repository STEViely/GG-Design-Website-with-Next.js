...
export default function HeroSection({ targetSectionRef1, targetSectionRef2 }) {
  ...
  return (
    <div className="w-full relative drop-shadow-lg">
      ...
      <div className="absolute top-0 left-0 w-full h-full z-10 text-white flex flex-col items-center justify-center gap-4">
        ...
        <div className="flex gap-4">
          <div
            ...
            className="border border-white  rounded-lg p-4 w-[50%] hover:bg-white hover:text-[rgba(0,19,59,0.8)] flex flex-col  items-center justify-center md:w-[300px] md:h-[250px] lg:w-[350px] lg:h-[300px] xl:w-[500px] xl: 2xl:w-[600px] 2xl:h-[400px]"
          >
          ...
          <div
            ...
            className="border border-white p-4 w-[50%] rounded-lg hover:bg-white hover:text-[rgba(0,19,59,0.8)] flex flex-col  items-center justify-center md:w-[300px] md:h-[250px] lg:w-[350px] lg:h-[300px] xl:w-[500px] xl: 2xl:w-[600px] 2xl:h-[400px]"
          >
            <h1 className="text-[14px] md:text-[20px] lg:text-[28px] xl:text-[40px] 2xl:text-[45px]">
              Logo Design
            </h1>
