...
export default function Page() {
  const images = [
    { src: "/minimal/minimal (1).jpg", alt: "minimal" },
    { src: "/minimal/minimal (3).jpg", alt: "minimal" },
    { src: "/minimal/minimal (4).jpg", alt: "minimal" },
    { src: "/minimal/minimal (5).jpg", alt: "minimal" },
    { src: "/minimal/minimal (6).jpg", alt: "minimal" },
    { src: "/minimal/minimal (7).jpg", alt: "minimal" },
    { src: "/minimal/minimal (8).jpg", alt: "minimal" },
    { src: "/minimal/minimal (9).jpg", alt: "minimal" },
    { src: "/minimal/minimal (10).jpg", alt: "minimal" },
    { src: "/minimal/minimal (11).jpg", alt: "minimal" },
    { src: "/minimal/minimal (12).jpg", alt: "minimal" },
    { src: "/minimal/minimal (14).jpg", alt: "minimal" },
    { src: "/minimal/minimal (15).jpg", alt: "minimal" },
  ];
